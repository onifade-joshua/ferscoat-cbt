        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            ...
            <p className="text-base sm:text-lg text-gray-600 mb-8 sm:mb-10 max-w-xs sm:max-w-2xl mx-auto">
              Smart, secure, and easy-to-use CBT platform for schools of all
              sizes.
            </p>
          ...
          >
            ...
            <div className="relative w-full lg:w-1/2 flex-shrink-0">
              ...
              >
                ...
                {/* Small bottom badge */}
                <div
                  className="absolute bottom-4 right-4 bg-white text-gray-700 
            ...
            <div className="relative w-full lg:w-1/2 flex-shrink-0">
              ...
              >
                ...
                {/* Floating Badge */}
                <div
                  className="absolute top-4 left-4 bg-purple-600 text-white 
                      text-xs sm:text-sm md:text-base px-3 py-1 
                      rounded-full shadow-lg flex items-center gap-2"
                >
      ...
      <footer className="bg-gray-50 border-t border-gray-100 mt-12 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="flex flex-col gap-2">
              ...
              <p className="text-gray-600 text-sm sm:text-base mt-2">
                Modern computer-based testing platform for schools. Streamline
                exams, track performance, and ensure secure testing for all
                students.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2 text-gray-600 text-sm sm:text-base">
                <li className="flex items-center gap-2">
                  <Mail className="w-4 h-4 sm:w-5 sm:h-5" /> info@ferscoat.com
                </li>
                <li className="flex items-center gap-2">
                  <Github className="w-4 h-4 sm:w-5 sm:h-5" />{" "}
                  <a
                    href="https://github.com/ferscoat"
                ...
                <li className="flex items-center gap-2">
                  ...
                  <a
                    href="https://twitter.com/ferscoat"
                    className="hover:text-blue-600 transition"
                  >
                    Twitter
                  </a>
                ...
                <li className="flex items-center gap-2">
                  ...
                  <a
                    href="https://linkedin.com/company/ferscoat"
                    className="hover:text-blue-600 transition"
                  >
                    LinkedIn
                  </a>
          ...
          <div className="mt-8 sm:mt-12 border-t border-gray-100 pt-4 text-center text-gray-500 text-sm sm:text-base">
            &copy; {new Date().getFullYear()} FERSCOAT INT'L SCHOOL. All rights
            reserved.
          </div>
        </div>
